"""Monthly Prophet training nodes: hyperparameter tuning and final model fit."""
...
def tune_hyperparameters(
    ...
    """Run hyperparameter tuning for Prophet on monthly data.

    Args:
        train: Monthly training set in Prophet format (ds, y, optional regressors).
        validation: Held-out monthly validation set for candidate scoring.
        parameters: Content of train_monthly.yml under the 'train_monthly.prophet'
...
def train_best_candidate(
    ...
    Args:
        train: Monthly training set in Prophet format.
    ...
    Returns:
        Fitted Prophet model (prophet.Prophet) ready for test evaluation.
    """
    raise NotImplementedError(
